<template>
    <section class="b-investor-income">
        <div class="container">
            ...
            <div class="description">
                <p class="bonus">
                    ...
                    <span class="orange">&thinsp;{{t('to investors')}}</span>
                </p>
            </div>
            <ul class="list">
                <li class="item">
                    <p class="number">01</p>
                    <p class="text"><span class="bold">1800 CSNP </span> <br> {{t('token')}}</p>
                </li>
                <li class="item">
                    <p class="number">02</p>
                    <p class="text">
                        {{t('Participation in the distribution')}}
                        <span class="bold">15% {{t('shares')}}</span> {{t('among all co-producers')}}
                    </p>
                </li>
                <li class="item">
                    <p class="number">03</p>
                    <p class="text">
                        {{t('Participation in the distribution of')}}
                        <span class="bold">7% {{t('share')}}</span> {{t('of each series among all co-producers')}}
                    </p>
                </li>
            </ul>
            <p class="target-desc">
                {{t('It is planned to shoot')}} <span class="bold">28 {{t('seasons')}}</span>
                {{t('of 12 episodes in each season.')}}
            </p>
        </div>
    </section>
</template>
            ...
            .bonus {
                > span {
                    ...
                    &.light {
                        ...
                        color: #fff;
                        .sm-block({ margin-bottom: 0; margin-right: 5px; });
                    }
                    &.orange {
                        font-weight: 600;
                        letter-spacing: 0.17rem;
