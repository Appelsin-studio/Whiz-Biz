<template>
    <modal name="salamat" transition="pop-out" height="auto" width="100%" :max-width="850" :adaptive="true"
        ...
        <div class="modal modal-team b-modal-salamat ">
            ...
            <p class="person-desc">{{t('Salamat Mohammed-Ali is responsible for the strategic and creative vision of the company, and will also participate as a director / producer for selected projects.')}}</p>
